...
export function RecipeList({ recipes, onAddRecipe, onDeleteRecipe, onEditRecipe }: RecipeListProps) {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-4">
        <div className="flex justify-between items-start mb-2">
          <h3 className="font-bold text-lg text-gray-800 line-clamp-1">{recipe.title}</h3>
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">{recipe ? 'Edit Recipe' : 'New Recipe'}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              ...
              />
              <button type="button" onClick={addIngredient} className="bg-blue-600 text-white px-3 rounded-lg">
                <Plus size={20} />
              </button>
            </div>
